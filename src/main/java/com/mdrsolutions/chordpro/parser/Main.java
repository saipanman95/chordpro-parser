...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Loader<List<RawSongLine>, String, SongLineProducer> loader = new SongFileLoader(lineProducer);
        ...
        List<RawSongLine> songLines = loader.load("/Users/mrodgers/songfiles/testsong.chordpro");
